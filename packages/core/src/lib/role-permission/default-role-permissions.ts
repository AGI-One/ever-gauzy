...
export const DEFAULT_ROLE_PERMISSIONS = [
	{
		role: RolesEnum.PLATFORM_ADMIN,
		defaultEnabledPermissions: [
			// Platform Admin has ALL permissions since they manage the entire platform
			// AND also have full access to their own tenant/organization
